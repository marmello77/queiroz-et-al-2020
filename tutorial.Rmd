...
This tutorial is aimed at the reproducibility of the analyses and figures presented in our paper. Please follow the steps described in each section, to see how each figure was drawn. Use the summary below to navigate through the sections.
...
In this tutorial, we have set the permutations to **10**, in order to make analysis and knitting run faster. In our paper, we have set it to 1000, as you can see in the script "analysis.R" provided in this repo.
